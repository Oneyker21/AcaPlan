            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.profileCard}>
                    ...
                    <View style={styles.roleBadge}>
                        <Text style={styles.roleText}>
                            {profile?.rol === 'administrador' ? '🔑 Administrador' : '👨‍🏫 Docente'}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.infoCard}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <View style={[
                            styles.statusBadge,
                            { backgroundColor: profile?.estado === 'activo' ? Colors.success + '15' : Colors.error + '15' }
                        ]}>
                            <Text style={[
                                styles.statusText,
                                { color: profile?.estado === 'activo' ? Colors.success : Colors.error }
                            ]}>
                                {profile?.estado || '—'}
                            </Text>
                        </View>
